...
package com.cheek.iap;

import com.cheek.iap.Consts.PurchaseState;
import com.cheek.iap.util.Base64;
import com.cheek.iap.util.Base64DecoderException;
...
public class Security {
    ...
    public static ArrayList<VerifiedPurchase> verifyPurchase(String signedData, String signature) {
        ...
        if (!TextUtils.isEmpty(signature)) {
             ...
             */
            String base64EncodedPublicKey = "MIIBIjANBgkqhkiG9w0BAQEFAAOCAQ8A" +
                "MIIBCgKCAQEAyqpqZVj31CLi/VRfUd2KXQ6n3A6ugL3vhXI7+Q9LLdMzmtdr" +
            	"ZY/oS+YhpCaD8H9EcY8mbgIA9gVKCekNGlcyWEZftLZ4CWeCvc4c/byXkQ3t" +
                "akArhh90TUk3Ml9+g3lW+9FID8L40UEMKfmsQcboKNECFvqK+NZHetzKOqA8" +
            	"XRh0RerhFt6Nnh5Xy2ifV7qBVZ2dASQ5/Cl/0zqntwxBN0YtQxRzp/tfE/kc" +
                "puYzqX8JrOgOqKNyWV/bqqlR2CacRquVh866gPax2Q+Cnrq43Kl3pQEMv/2q" +
            	"SOXkW9Jeq6h/ej0sksQK2oOanYYl2x7Gfeq1tcpTWZkPP3sMeI4gowIDAQAB";
