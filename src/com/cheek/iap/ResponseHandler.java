...
public class ResponseHandler {
    ...
    public static void purchaseResponse(
    	...
    	Log.i(TAG, "purchaseResponse() purchaseState: " + purchaseState +
    	...
    	if (purchaseState == Consts.PurchaseState.PURCHASED) {
    		...
    		final String URLBase = 
    			context.getString(com.cheek.celestialglory.R.string.url_purchase)
	        ...
	        new Thread(new Runnable() {
	            public void run() {
	                ...
	                try {
	                    ...
	                    String newString = new Scanner(is).useDelimiter("\\A").next(); 
	                    // convert to String
